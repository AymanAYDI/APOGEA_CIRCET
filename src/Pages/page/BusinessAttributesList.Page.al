...
*/
page 50001 "Business Attributes List"
{
    ApplicationArea = All;
    Caption = 'Business Attributes List', Comment = '{ "instructions": "", "translations": [ { "lang": "FRA", "txt": "Liste attributs affaire" } ] }';
    PageType = List;
    SourceTable = "Business Attributes";
    UsageCategory = Lists;
    CardPageId = "Business Attributes";
    Editable = false;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the County', Comment = '{ "instructions": "", "translations": [ { "lang": "FRA", "txt": "Région" } ] }';
                    ApplicationArea = All;
                }
                field("Country/Region Code 2"; Rec."Country/Region Code 2")
                {
                    ToolTip = 'Specifies the value of the Country/Region Code 2', Comment = '{ "instructions": "", "translations": [ { "lang": "FRA", "txt": "" } ] }';
                    ApplicationArea = All;
                }
