page 50017 "Mod Posted Sales Inv."
{
    Caption = 'Modify Posted Sales Invoice', Comment = '{"instructions":"","translations":[{"lang":"FRA","txt":"Modifier la facture de vente enregistrée"}]}';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Total Weigth"; Rec."Total Weight")
                {
                    ApplicationArea = All;
            ...
            part(PostSalesInvLines; "Mod Post Sales Inv. Lines")
            {
                ApplicationArea = All;
